...
//
//	// 値の更新
//	this->m_currentValue_ = newValue;
//	auto isDirty = this->m_currentValue_ != newValue;	// 変更前の値と変更後の値が違うときだけ、変更通知を呼び出すようにするぜ☆（＾ｑ＾）
//
//	// 変更通知
//	if (isDirty && this->m_onChanged_ != nullptr) {
//		this->m_onChanged_(*this);
//	}
//
//	return *this;
//}
